...
public class CajitaDaoImpl implements CajitaDao {
    ...
    @Override
    public List<CjaGastosEjecutados> listarCjaGastosEjecutadosPorIdCjaIngresoIdUsuarioJPQL(Long idCjaIngreso, Long id) {
    ...
    @Override
    public List<CjaGastosEjecutados> listarGastoEjecutadosPorIdUsuarioFecIngresoFecPagoJPQL(Long id, Long idCjaIngreso, Date fecIngreso, Date fecGasto) {
        String sql = " SELECT cge "
    ...
    @Override
    public List<CjaGastosEjecutados> listarGastosEjecutadosGestionPeriodoIdUsuarioJPQL(Integer periodo, Integer gestion, Long id) {
    ...
    @Override
    public List<CjaTiposClasificacionesResponse> listarTiposClasificacionResponseIdUsuarioIdCjaIngresoJPQL(Long id, Long idCjaIngreso, Date fecIngreso, Date fecGasto) {
    ...
    @Override
    public List<CjaGastosClasificacionesResponse> listarGastosClasificacionResponseIdUsuarioIdCajaIngresoJPQL(Long id, Long idCjaIngreso) {
    ...
    @Override
    public List<CjaGastosEjecutados> listarGastosPorIdPersonaGestionPeriodoIdUsuarioJPQL(Long idPersona, Integer gestion, Integer periodo, Long id, Long idCjaIngreso) {
        String sql = " SELECT cge "
                + " FROM CjaGastosEjecutados cge LEFT JOIN cge.personas p  "
                + " LEFT JOIN cge.cjaIngresos cif "
                + " LEFT JOIN cge.cjaTiposGastos ctg "
    ...
    @Override
    public List<CjaGastosEjecutados> listarGastosEjecutadosGestionPeriodoIdUsuarioIdCjaIngresoJPQL(Integer periodo, Integer gestion, Long id) {
        String sql = "SELECT gts FROM CjaGastosEjecutados gts "
