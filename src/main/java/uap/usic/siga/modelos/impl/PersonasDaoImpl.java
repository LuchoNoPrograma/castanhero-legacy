...
public class PersonasDaoImpl implements PersonasDao {
    ...
    @Override
    public Personas buscarPersonaPorIdUsuarioGET(Long id) {
        String sql = " Select p "
    ...
    @Override
    public PnlPersonalAdministrativos buscarPnlPersonalAdministrativosPorIdPersonaIdEstadoGET(Long idPersona,
            String idEstado) {
    ...
    @Override
    public List<Personas> listarCjaGastosEjecutadosPersonasPorIdCjaIngresoIdUsuarioJPQL(Long idCjaIngreso, Long id) {
    ...
    @Override
    public List<Personas> listarPersonalAdministrativoActivosJPQL() {
        String sql = " SELECT prs   FROM PnlPersonalAdministrativos pnl LEFT JOIN pnl.personas prs "
                + " WHERE prs.idEstado = 'A'  "
                + " AND pnl.idEstado = 'A' "
                + " ORDER BY prs.paterno ";
        Query q = em.createQuery(sql);
        return q.getResultList();
    ...
    @Override
    public List<PrsEstadoCivil> listarEstadoCivilJPQL() {
        String sql = "SELECT st FROM PrsEstadoCivil st "
                + " WHERE st.idEstado = 'A' ";
        Query q = em.createQuery(sql);
        return q.getResultList();
    }
    ...
    @Override
    public PrsGradosAcademicos buscarGradoAcademicoPorIdGET(Long id) {
        String sql = " SELECT ga "
                + " FROM PrsGradosAcademicos ga"
                + " WHERE ga.id = :id "
                + " AND ga.idEstado = 'A' ";
    ...
    @Override
    public PrsEstadoCivil buscarEstadoCivilPorIdGET(Long id) {
        String sql = " SELECT ec "
                + " FROM PrsEstadoCivil ec"
                + " WHERE ec.id = :id "
                + " AND ec.idEstado = 'A' ";
        Query q = em.createQuery(sql);
        q.setParameter("id", id);
        try {
            return (PrsEstadoCivil) q.getSingleResult();
        } catch (Exception e) {
            return null;
        }
    }
    ...
    public PrsTiposSexos buscarSexoPorId(Long id) {
        String sql = " SELECT p "
                + " FROM PrsTiposSexos p"
                + " WHERE p.idPrsTipoSexo = :id "
                + " AND p.idEstado = 'A' ";
        Query q = em.createQuery(sql);
        q.setParameter("id", id);
        try {
    ...
    public PrsCiExpedidos buscarCiExpedidosPorId(Long id) {
        String sql = " SELECT p "
                + " FROM PrsCiExpedidos p"
                + " WHERE p.idPrsCiExpedido = :id "
                + " AND p.idEstado = 'A' ";
        Query q = em.createQuery(sql);
        q.setParameter("id", id);
        try {
