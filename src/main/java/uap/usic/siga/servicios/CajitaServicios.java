...
public interface CajitaServicios {
    ...
    public List<CjaGastosEjecutados> listarGastoEjecutadosPorIdUsuarioFecIngresoFecPago(Long id, Long idCjaIngreso, Date fecIngreso, Date fecGasto);
    ...
    public List<CjaGastosEjecutados> listarGastosEjecutadosGestionPeriodoIdUsuario(Integer periodo, Integer gestion, Long id);
    ...
    public List<CjaTiposClasificacionesResponse> listarTiposClasificacionResponseIdUsuarioIdCjaIngreso(Long id, Long idCjaIngreso,Date fecIngreso,Date fecGasto);

    public List<CjaGastosClasificacionesResponse> listarGastosClasificacionResponseIdUsuarioIdCajaIngreso(Long id, Long idCjaIngreso);

    public List<CjaGastosEjecutados> listarGastosPorIdPersonaGestionPeriodoIdUsuario(Long idPersona, Integer gestion, Integer periodo, Long id,Long idCjaIngreso);
  ...
  // actualizar
    ...
    public List<CjaGastosEjecutados> listarGastosEjecutadosGestionPeriodoIdUsuarioIdCjaIngreso(Integer periodo, Integer gestion, Long id);
