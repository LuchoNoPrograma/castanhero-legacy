...
public class AdministrarEnfrentamientos {
	...
	@GetMapping(value = "/listarEnfrentamiento/{id}")
	public String listarEnfrentamientos(@PathVariable("id") long idEtapa, Model model, HttpSession session) {
		...
		for (OoEnfrentamientos enfrentamientos : oServicios.listarOoEnfrentamientosPorIdEtapa(idEtapa)) {
			System.out.println(enfrentamientos.getIdEnfrentamientos());
			for (OoDetalleEnfrentamientos detalleEnfrentamientos : enfrentamientos.getOoDetalleEnfrentamientos()) {
	...
	@PostMapping(value = "/inicioFormEnfrenta")
	...
	public String registrarEquipoParticipantes(
		...
		oServicios.registrarOoEnfrentamientos(ooEnfrentamientos);
		...
		return "redirect:listarEnfrentamiento/" + ooEnfrentamientos.getOoEtapas().getIdEtapa();

	}
	
	@GetMapping(value = { "/enfrentamientos/{idEnfrentamientos}"})
    public String index (@PathVariable("idEnfrentamientos") Long idEnfrentamientos, Model model){
	    OoEnfrentamientos enfrentamientos = oServicios.buscarEnfrentamientos(idEnfrentamientos);
