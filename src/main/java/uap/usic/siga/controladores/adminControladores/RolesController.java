package uap.usic.siga.controladores.adminControladores;
...
public class RolesController {
    ...
    public String updateRole(Model model, @PathVariable Long id,
                             @ModelAttribute("oldRole") @Valid final Roles role,
                             BindingResult bindingResult,
                             RedirectAttributes redirectAttributes) {
        Optional<Roles> persistedRole = roleService.findById(id);
    ...
    public String saveNewRole(@ModelAttribute("newRole") @Valid final Roles newRole,
                              BindingResult bindingResult,
                              RedirectAttributes redirectAttributes) {
