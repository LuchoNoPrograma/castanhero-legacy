...
public class GdocResolucionesDigitales extends SigaUsicGestiones {
   ...
   private String esdadoResolucion;
    ...
    @NotNull
    @Column(name = "contenido_resol_pdf")
   private String contenidoResolPdf = "html";

    public String getContenidoResolPdf() {
		return contenidoResolPdf;
	}

	public void setContenidoResolPdf(String contenidoResolPdf) {
		this.contenidoResolPdf = contenidoResolPdf;
	}
