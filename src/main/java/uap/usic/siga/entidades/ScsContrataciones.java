...
public class ScsContrataciones extends SigaUsicGestiones {
    ...
    @OnDelete(action = OnDeleteAction.CASCADE)
    @JsonIgnore
    private ScsPrsContratados scsPrsContratados;
	...
	public ScsPrsContratados getScsPrsContratados() {
		return scsPrsContratados;
	}

	public void setScsPrsContratados(ScsPrsContratados scsPrsContratados) {
		this.scsPrsContratados = scsPrsContratados;
	}
